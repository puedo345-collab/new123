  ...
  <div class="bg-slate-50 p-4 rounded-xl border border-slate-200/60 my-4">
    <div class="space-y-4">
      <div>
        ...
        <p class="text-xs sm:text-[13.5px] text-slate-650 pl-3 mt-1 leading-relaxed">
          울산의 선박 블록 공장에서 일용직으로 종사하던 50대 초반 C씨는 불규칙한 건설 경기와 일용직 수급 한계로 생활고를 겪게 되었습니다. 부양해야 할 노부모의 치매 병원비와 요양원 분담금을 내기 위해 카드 돌려막기와 소액 대부업체를 이용하게 되었고, 부채는 7,200만 원에 육박하여 채무 불이행 위험에 직면했습니다.
        </p>
      </div>
  ...
  <div class="bg-slate-50 p-4 rounded-xl border border-slate-200/60 my-4">
    <div class="space-y-4">
      <div>
        ...
        <p class="text-xs sm:text-[13.5px] text-slate-650 pl-3 mt-1 leading-relaxed">
          울산 남구 삼산동 학원 밀집가에서 수학 전문 강사로 일하던 40대 F씨는 학원 휴원과 정원 축소 조치에 따라 정산 소득이 급감했습니다. 모친의 당뇨 투병 병원비와 한부모 가정으로서의 육아 생활비를 고금리 대출로 충당하다 보니, 누적된 채무가 8,500만 원에 이르게 되어 채무 불이행 위험에 내몰렸습니다.
        </p>
      </div>
  ...
  <div class="bg-slate-50 p-4 rounded-xl border border-slate-200/60 my-4">
    <div class="space-y-4">
      ...
      <div>
        ...
        <p class="text-xs sm:text-[13.5px] text-slate-650 pl-3 leading-relaxed">
          공장 설비 및 사업 자산 평가액이 무리하게 책정되어 회생을 주저하는 제조업 및 기업형 자영업자가 자산 가치의 잔존 실체를 서류상으로 파괴 및 입증하는 전략에 따라 극적인 탕감 기회를 쟁취할 수 있음을 확신시켜 줍니다.
        </p>
      </div>
    </div>
  </div>
