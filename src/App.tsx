...
export default function App() {
  ...
  const handleWorryChipClick = (index: number) => {
    const faqIdMap: Record<number, number> = {
      0: 1, // 부동산경매 절차개시! -> 채권자가 주택에 경매 (id 1)
      1: 3, // 집에 빨간딱지가! -> 집에 빨간딱지(유체동산압류) (id 3)
      2: 4, // 전화 독촉 스트레스! -> 채무 독촉 언제 중단 (id 4)
      3: 5, // 코인 및 주식 투자손실 -> 주식 코인 투자 (id 5)
      4: 2, // 전부 최근 대출이에요! -> 최근 1년 이내 대출 (id 2)
      5: 6  // 배우자 몰래 진행하기! -> 직장 가족 몰래 (id 6)
    };
