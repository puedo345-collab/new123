...
export default function BankruptcyNotes({ onBack, onStartSurvey }: BankruptcyNotesProps) {
  return (
    <motion.div
      ...
      className="bg-[#FAF9F5] min-h-screen pt-7 pb-16 md:pt-9 md:pb-24 text-slate-800 font-sans break-keep"
      ...
      <div className="max-w-5xl md:max-w-6xl mx-auto px-4 sm:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="space-y-4 sm:space-y-6">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-slate-900 tracking-tight px-1 text-center leading-[1.12]">
              신청 자격 3가지 요건
            </h2>
          </div>
