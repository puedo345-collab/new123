...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: '채권자가 경매를 신청해서 경매 절차가 개시되었다 하더라도, 주택이나 부동산의 소유자는 개인회생 신청과 동시에 중지명령을 신청할 수 있고, 법원으로부터 받은 중지명령 결정이 있으면 중지명령 결정문을 경매가 진행되고 있는 집행법원의 해당 경매계에 제출해 경매절차를 개시결정 시까지 정지 시켜달라는 "부동산 강제경매(또는 임의경매) 정지 신청서"를 제출해 경매 절차를 일시 정지 시킬 수 있습니다. 다만 개인회생 인가결정 후 정지되어 있던 경매 절차를 완전히 취소 시킬 수 있는지 여부는, 그 경매가 "일반 채권자가 신청한 강제경매"인지 또는 "근저당권자 등 담보권자가 신청한 임의경매"인지 여부에 따라 달라지므로 이 부분을 잘 파악하고 대응해야 합니다.'
  },
  {
    id: 2,
